...
class ChainSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Chain
        fields = ("url", "name", "description", "slogan", "founded_date", "website")
...
class StoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Store
        fields = (
            "url", "chain", "number", "address", "opening_date",
...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employee
        fields = ("url", "store", "number", "first_name", "last_name", "hired_date")

class RoomInfoSerializer(serializers.ModelSerializer):
    class Meta:
        model = RoomInfo
        fields = ("url", "description", "photo")
